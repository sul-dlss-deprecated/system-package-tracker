...
RSpec.describe Import::Yum, type: :model do
  ...
  describe '#load_centos_advisories' do
    it 'fetch centos advisories' do
      stub_const('Import::Yum::PROXY_ADDR', '')
      xml_data = described_class.new.load_centos_advisories
  ...
  describe '#centos_advisories' do
    ...
    it 'load known data and check state' do
      ...
      allow(import).to receive(:load_centos_advisories).and_return(xml)
  ...
  describe '#load_rhel_advisories' do
  end
